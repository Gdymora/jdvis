...
## adminPanel додані події:
Події:
adminPanelInitialized: викликається відразу після рендерингу HTML адмін-панелі.
beforeMenuItemClick: викликається перед обробкою кліку на пункт меню, може бути скасована.
beforeContentLoad: викликається перед завантаженням контенту для вибраного пункту меню.
afterContentLoad: викликається після завантаження контенту.
Специфічні події для кожного розділу (наприклад, usersLoaded, rolesLoaded).
accessDenied: викликається, коли у користувача немає доступу до розділу.
pageNotFound: викликається, коли вибрано неіснуючий пункт меню.
beforeLogout: викликається перед виходом з системи, може бути скасована.
logoutSuccess та logoutError: викликаються після спроби виходу з системи.
adminPanelReady: викликається в кінці ініціалізації, коли адмін-панель повністю готова до роботи.
